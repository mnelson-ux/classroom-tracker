...
export default function TeacherPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gray-50 md:flex-row">
      {/* Sidebar */}
      <aside className="flex flex-col gap-1 bg-purple-800 p-4 md:w-64 md:min-h-screen">
        ...
        <a href={`/${school}`} className="flex items-center gap-3 rounded-xl px-4 py-2.5 text-sm font-semibold text-purple-100 transition hover:bg-white/10">🖥️ Kiosk</a>
        <button onClick={handleLogout} className="mt-1 flex items-center gap-3 rounded-xl px-4 py-2.5 text-left text-sm font-semibold text-purple-100 transition hover:bg-white/10">🚪 Log Out</button>
      </aside>
