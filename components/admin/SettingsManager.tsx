...
export default function SettingsManager({ settings, token, school, onRefresh }: Props) {
  ...
  const groups = [
    ...
    { title: 'Bathroom Limits', keys: ['max_bathroom_per_room_boys', 'max_bathroom_per_room_girls', 'max_bathroom_total_boys', 'max_bathroom_total_girls', 'time_limit_minutes', 'max_recorded_minutes'] },
